...
#set libdir      "/home/wechan/libraries/cmp28/8T/"
set runDir /users/sh33/data/sh33/Sofiane/riscv_180
set outputDir "${runDir}/output/"
...
#set libdir "${runDir}/input/db"
set libdir "${runDir}/libtsmc180/"

# Target library
set tl_list [glob $libdir/tcb018gbwp7tbc_ccs.db] 
set ll_list [glob $libdir/tcb018gbwp7tbc_ccs.db] 


#set ll_list [glob "${libdir}/contest.db"] 
#set list_lib "$libdir/asap7.db"
...
read_sdc ./input/constraint/${top_module}.sdc
...
if {![file exists $outputDir/LS]} {
  exec mkdir $outputDir/LS/
}

file copy -force -- ./gate/${top_module}.v ${outputDir}/LS/
file copy -force -- ./gate/${top_module}.sdc ${outputDir}/LS/
